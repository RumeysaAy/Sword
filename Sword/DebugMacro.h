...
#define DRAW_SPHERE_SingleFrame(Location) if (GetWorld()) DrawDebugSphere(GetWorld(), Location, 25.f, 12, FColor::Orange, false, -1.f);
...
#define DRAW_LINE_SingleFrame(StartLocation, EndLocation) if (GetWorld()) DrawDebugLine(GetWorld(), StartLocation, EndLocation, FColor::Orange, false, -1.f, 0, 1.f);
...
{ \
DrawDebugLine(GetWorld(), StartLocation, EndLocation, FColor::Orange, false, -1.f, 0, 1.f); \
DrawDebugPoint(GetWorld(), EndLocation, 15.f, FColor::Orange, false, -1.f); \
}

// DrawDebugSphere(GetWorld(), StartLocation, 25.f, 12, FColor::Purple, true);
